...
function bgArt(id){
  switch(id){
    ...
    case 'kumo': return `<div class="sky" style="background:linear-gradient(180deg,#8FD6FF 0%,#CFEFFF 40%,#F2FAFF 100%)"></div>
      ${rsun(80,10,22,'#FFF9D0','#FFD86B',0)}${clouds([[12,14,30],[46,8,26],[70,24,20],[26,28,18],[90,34,16]])}
      ${land(`<path d="M-20 60 Q40 30 110 56 Q180 78 260 52 Q330 30 420 58 L420 140 L-20 140 Z" fill="#FFFFFF" opacity=".95"/>
        <path d="M-20 84 Q60 60 140 84 Q220 106 300 82 Q370 62 420 84 L420 140 L-20 140 Z" fill="#EAF6FF"/>
        ${[40,120,210,300,370].map((x,i)=>`<circle cx="${x}" cy="${104+i%2*10}" r="${12+i%3*4}" fill="#fff"/>`).join('')}
        ${[70,180,290,360].map((x,i)=>`<path d="M${x} ${96+i%2*8} l2 5 5 2 -5 2 -2 5 -2 -5 -5 -2 5 -2 z" fill="#FFD22E" stroke="#2B2018" stroke-width="1.4"/>`).join('')}`)}`;
...
const MAP_ITEMS=[["🌷",40.4,66.5],["🌻",25.9,73.2],["🌼",18.3,71.7],["🍄",53.2,45.3],["🌲",90.8,80.5],["🪨",37.0,23.3],["🦋",80.3,94.0],["🐞",7.7,71.2],["🐝",70.7,22.4],["🐦",8.7,35.2],["🎈",35.1,40.7],["🍎",63.2,80.3],["🍓",91.5,92.9],["⭐",59.1,67.6],["🌸",13.6,40.9],["🌵",94.2,22.7],["🪵",45.9,77.0],["🐚",35.2,69.2],["🍀",30.0,38.5],["🦆",67.4,92.6],["🐢",74.1,27.9],["🌺",73.9,93.7],["🍁",36.4,6.0],["🐇",38.8,30.4],["🧺",9.5,60.3],["⛲",21.5,45.9],["🪁",52.2,69.5],["🎏",46.5,69.5],["🍉",10.9,27.4],["🐈",30.0,21.3],["🪻",8.0,48.4],["🌾",5.5,5.0],["🦔",32.0,87.1],["🍒",53.7,33.8],["🎀",53.8,89.7],["🪷",66.6,34.1],["🐿️",41.8,53.5],["🌰",45.6,41.1],["🪄",86.9,71.5],["🕊️",55.0,75.6],["🍋",57.7,83.4],["🐌",59.1,33.2],["🌙",68.6,59.9],["🪺",28.3,11.7],["🧸",92.3,47.7],["🎠",45.8,21.2],["🍇",31.8,78.9],["🍊",27.4,83.3],["🌳",74.9,46.7],["🦢",92.5,30.1],["🐠",59.2,40.3],["🌊",16.5,64.2],["⛵",40.9,46.9],["🏖️",73.4,39.3],["🪸",15.6,55.2],["🐙",78.4,67.7],["🦀",65.2,40.8],["🐳",33.6,13.4],["☁️",68.5,47.6],["🌈",48.7,29.8],["🎪",6.5,78.3],["🎡",7.3,22.0],["🎢",73.1,64.1],["🎨",72.0,14.9],["🪀",62.2,87.3],["🧩",85.8,89.7],["🎲",66.7,68.4],["🪅",57.4,9.6],["🍿",91.9,6.9],["🧁",31.5,94.8],["🍩",24.0,40.0],["🍬",43.9,33.0],["🚲",66.8,17.0],["🚂",94.7,74.8],["🎺",22.3,63.2],["🥁",48.5,55.2],["🪈",85.1,83.0],["📚",93.7,66.8],["🔭",26.8,5.0],["🗺️",72.6,55.2],["🧭",16.1,47.1],["⛺",49.0,61.8],["🔥",32.7,28.9],["🍢",94.4,39.5],["🎋",46.3,49.0],["🏮",24.1,92.4],["🪴",38.4,77.0],["🌱",5.1,91.8],["🐣",39.5,59.5],["🦎",76.3,6.5],["🦒",86.4,27.2],["🐘",82.0,49.3]];
